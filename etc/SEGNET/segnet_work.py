...
def segnet(input_shape=(256,256,1), n_labels=1, kernel=3, pool_size=(2, 2), output_mode="sigmoid"):
    # encoder
    ...
    conv_2 = Convolution2D(8, (kernel,kernel), padding="same")(conv_1)
    ...
    # Level-2
    conv_3 = Convolution2D(16, (kernel,kernel), padding="same")(pool_1)
    conv_3 = BatchNormalization()(conv_3)
    conv_3 = Activation("relu")(conv_3)
    conv_4 = Convolution2D(16, (kernel,kernel), padding="same")(conv_3)
    ...
    # Level-3
    conv_5 = Convolution2D(32, (kernel,kernel), padding="same")(pool_2)
    conv_5 = BatchNormalization()(conv_5)
    conv_5 = Activation("relu")(conv_5)
    conv_6 = Convolution2D(32, (kernel,kernel), padding="same")(conv_5)
    conv_6 = BatchNormalization()(conv_6)
    conv_6 = Activation("relu")(conv_6)
    conv_7 = Convolution2D(32, (kernel,kernel), padding="same")(conv_6)
    ...
    # Level-4
    conv_8 = Convolution2D(64, (kernel,kernel), padding="same")(pool_3)
    ...
    conv_17 = Convolution2D(64, (kernel,kernel), padding="same")(unpool_2) #64x64x64
    conv_17 = BatchNormalization()(conv_17)
    conv_17 = Activation("relu")(conv_17)
    conv_18 = Convolution2D(64, (kernel,kernel), padding="same")(conv_17)
    conv_18 = BatchNormalization()(conv_18)
    conv_18 = Activation("relu")(conv_18)
    conv_19 = Convolution2D(64, (kernel,kernel), padding="same")(conv_18)
    ...
    conv_20 = Convolution2D(32, (kernel,kernel), padding="same")(unpool_3)
    conv_20 = BatchNormalization()(conv_20)
    conv_20 = Activation("relu")(conv_20)
    conv_21 = Convolution2D(32, (kernel,kernel), padding="same")(conv_20)
    conv_21 = BatchNormalization()(conv_21)
    conv_21 = Activation("relu")(conv_21)
    conv_22 = Convolution2D(32, (kernel,kernel), padding="same")(conv_21)
    ...
    conv_23 = Convolution2D(16, (kernel), padding="same")(unpool_4)
    conv_23 = BatchNormalization()(conv_23)
    conv_23 = Activation("relu")(conv_23)
    conv_24 = Convolution2D(16, (kernel), padding="same")(conv_23)
    ...
    conv_25 = Convolution2D(8, (kernel), padding="same")(unpool_5) #512x512x8
